        ...
        <>
            <div className={style.servicesContainer}>
                <div className={style.serviceItem}>
                    ...
                    <p className={style.servicePrice}>from $3,500 <span className={style.aud}>AUD</span></p>
                </div>
                <div className={style.serviceItem}>
                    ...
                    <p className={style.servicePrice}>from $5,500 <span className={style.aud}>AUD</span></p>
                </div>
                <div className={style.serviceItem}>
